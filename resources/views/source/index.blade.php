                ...
                <div class="tbl">
                    <div class="tbl-row">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-sm btn-success" href="{{ route('sources.create') }}">Add New Source</a>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <div class="card-block">
                    ...
                    <table id="example" class="display table" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('sources.edit',$source->id) }}">Edit</a>
                                {!! Form::open(['method' => 'DELETE','route' => ['sources.destroy', $source->id],'style'=>'display:inline', 'id' => 'btn-submit']) !!}
