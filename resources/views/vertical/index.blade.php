                ...
                <div class="tbl">
                    <div class="tbl-row">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-sm btn-success" href="{{ route('verticals.create') }}">Add New Vertical</a>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <div class="card-block">
                    ...
                    <table id="example" class="display table" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('verticals.edit',$vertical->id) }}">Edit</a>
                                {!! Form::open(['method' => 'DELETE','route' => ['verticals.destroy', $vertical->id],'style'=>'display:inline', 'id' => 'btn-submit']) !!}
