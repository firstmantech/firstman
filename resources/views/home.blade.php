                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <article class="statistic-box red">
                                <div>
                                    <div class="number">{{ FirstMan::follow_up() }}</div>
                                    <div class="caption"><div>Open Followups</div></div>
                                    <!-- <div class="percent">
                        ...
                        <div class="col-sm-6">
                            <article class="statistic-box purple">
                                <div>
                                    <div class="number">{{ FirstMan::close_sale() }}</div>
                                    <div class="caption"><div>Closed</div></div>
                                    <!-- <div class="percent">
                        ...
                        <div class="col-sm-6">
                            <article class="statistic-box yellow">
                                <div>
                                    <div class="number">{{ FirstMan::sales() }}</div>
                                    <div class="caption"><div>Converted</div></div>
                                    <!-- <div class="percent">
                                        <div class="arrow down"></div>
                                        <p>5%</p>
                                    </div> -->
                        ...
                        <div class="col-sm-6">
                            <article class="statistic-box green">
                                <div>
                                    <div class="number">{{ FirstMan::follow_up_today() }}</div>
                                    <div class="caption"><div>Today Followups</div></div>
                                    <!-- <div class="percent">
                                        <div class="arrow up"></div>
                                        <p>84%</p>
                                    </div> -->
