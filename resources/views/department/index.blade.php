                ...
                <div class="tbl">
                    <div class="tbl-row">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-sm btn-success" href="{{ route('departments.create') }}">Add New Department</a>
                        </div>
                    </div>
                </div>
            </header>
                    ...
                    <table id="example" class="display table" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {!! Form::open(['method' => 'DELETE','route' => ['departments.destroy', $department->id],'style'=>'display:inline', 'id' => 'btn-submit']) !!}
