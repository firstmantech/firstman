                ...
                <div class="tbl">
                    <div class="tbl-row">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-sm btn-success" href="{{ route('states.create') }}">Add New State</a>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <div class="card-block">
                    ...
                    <table id="example" class="display table" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('states.edit',$state->id) }}">Edit</a>
                                {!! Form::open(['method' => 'DELETE','route' => ['states.destroy', $state->id],'style'=>'display:inline', 'id' => 'btn-submit']) !!}
